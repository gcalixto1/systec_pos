...
<div class="card-header">
    ...
    <div class="col-lg-12">
            ...
            <div class="input-group col-md-6">
                ...
                <button type="button" id="buscar_producto" class="btn btn-dark"><i class="fa fa-search"></i> Mostrar Producto</button> <!-- Botón de búsqueda -->
            </div>
            <br />
...
$(document).ready(function(){
    ...
    $('#buscar_producto').click(function(){
        ...
        $.ajax({
            ...
            data: {codproducto: codigo_producto},
            success: function(data){
                $('#resultado_busqueda').html(data); // Actualizar la tabla de resultados con los datos recibidos
            }
        });
    });
