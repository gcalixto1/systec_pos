...
if (empty($_REQUEST['cl']) || empty($_REQUEST['f'])) {
	...
	$productos = mysqli_query($conexion, "SELECT d.idfactura, d.cod_producto, d.cantidad, p.codproducto, p.descripcion, p.precio FROM detallefactura d INNER JOIN producto p ON d.idfactura = $noFactura WHERE d.cod_producto = p.codproducto");
