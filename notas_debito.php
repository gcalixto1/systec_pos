...
<div class="container-fluid">
    <div class="card-header">
        <h4 class="card-title text-black"><i class="fa fa-box"></i> CREAR NOTA DE DEBITO</h4>
    </div>
    <br>
    <div class="card">
...
$('#savecliente').submit(function(e) {
    ...
    $.ajax({
        url: 'ajax.php?action=saveNotasDebito',
        method: 'POST',
        data: formData,
        processData: false,
        contentType: false,
                ...
                $.ajax({
                    ...
                    success: function(respDte) {
                        ...
                        if (respDte.success) {
                            ...
                            Swal.fire({
                                title: '¡Éxito!',
                                text: 'NOTA DE DEBITO guardada y procesada correctamente.',
                                icon: 'success',
                                confirmButtonText: 'Ver Comprobante'
                            }).then(() => {
                                window.open(
                                    `facturaElectronica.php?codigodebito=${encodeURIComponent(codigo)}&tipo=ND`,
                                    '_blank'
                                );
                                location.reload();
                            });
