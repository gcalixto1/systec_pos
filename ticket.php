...
if(empty($_REQUEST['id']))
	{
		...
		$productos = mysqli_query($conexion, "SELECT d.idfactura, d.cod_producto, d.cantidad, p.codBarra, p.descripcion, p.precio FROM detallefactura d INNER JOIN producto p ON d.idfactura = $id_factura WHERE d.cod_producto = p.codBarra");
