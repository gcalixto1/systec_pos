      ...
      success: function (resp1) {
        if (resp1) {
          ...
          if ($size1 != '') {
            ...
            $('#uni_modal_documentos .modal-dialog').removeAttr("class").addClass("modal-dialog modal-xl")
          }
      ...
      success: function (resp1) {
        if (resp1) {
          ...
          if ($size1 != '') {
            ...
            $('#uni_modal_generador .modal-dialog').removeAttr("class").addClass("modal-dialog modal-md")
          }
