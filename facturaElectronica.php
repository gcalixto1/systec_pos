...
$id = $_GET['id'];
$sql = "SELECT correo_enviado,selloRecibido,jsondte FROM respuestadte INNER JOIN factura ON factura.id = respuestadte.id_factura WHERE id_factura = $id";
...
if ($row['correo_enviado'] == 0) {
    ...
    try {
        ...
        $save = $conexion->query("UPDATE factura SET correo_enviado = 1 WHERE id = $id");
