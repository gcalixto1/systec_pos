...
$url = MH_ENVIO_DTE_URL_CONTINGENCIA;
...
if (curl_errno($ch)) {
    ...
    if (isset($respuesta['fechaHora'])) {
        $fechaOriginal = str_replace("/", "-", $respuesta['fechaHora']); // "24/04/2025 19:45:03" → "24-04-2025 19:45:03"
    ...
    $id_factura = 0; // Cambia esto por el ID real de la factura que estás procesando
