...
(function (f) {
  ...
  function kb(a) {
    if (!q.__browser) {
      ...
      b.bScrollOversize = 10 === e[0].offsetWidth && 10 !== d[0].clientWidth;
  ...
  q.defaults = {
    ...
    oLanguage: {
      ...
      sEmptyTable: "No se ha encontrado ningun resultado",
      sInfo: "Muestra _END_ de _TOTAL_ resultados",
      sInfoEmpty: "Mostrar 0 de 0 resultados",
