...
overflow:"hidden"}).append(f("<div/>").css({position:"absolute",top:1,left:1,width:100,overflow:"scroll"}).append(f("<div/>").css({width:"100%",height:10}))).appendTo("body"),d=c.children(),e=d.children();b.barWidth=d[0].offsetWidth-d[0].clientWidth;b.bScrollOversize=10===e[0].offsetWidth&&10!==d[0].clientWidth;b.bScrollbarLeft=1!==Math.round(e.offset().left);b.bBounding=c[0].getBoundingClientRect().width?!0:!1;c.remove()}f.extend(a.oBrowser,q.__browser);a.oScroll.iBarWidth=q.__browser.barWidth}
...
sNext:"Siguiente",sPrevious:"Anterior"},sEmptyTable:"No se ha encontrado ningun resultado",sInfo:"Muestra _END_ de _TOTAL_ resultados",sInfoEmpty:"Mostrar 0 de 0 resultados",sInfoFiltered:"(filtrado de _MAX_ en total)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostrar _MENU_ resultados",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Buscar:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No se encontraron resultados"},oSearch:f.extend({},q.models.oSearch),sAjaxDataProp:"data",
